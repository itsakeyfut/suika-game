...
6. **Stage and commit changes:**
   ...
   **Commit guidelines:**
   ...
   - Example: `feat(fruit): implement merge system\n\nCloses #5`
...
- Example: `feat(fruit): フルーツ合体システムの実装`
- Example: `fix(physics): 衝突判定のバグ修正`
- Example: `docs: READMEにホットリロード手順を追加`
